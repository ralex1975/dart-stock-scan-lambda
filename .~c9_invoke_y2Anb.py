...
#     print(sys.version)
    ...
    above2002percentNoCross['Symbol'].to_csv('/home/ec2-user/environment/dart-stock-scan-lambda/above2002percentNoCross')
    below2002percentNoCross['Symbol'].to_csv('/home/ec2-user/environment/dart-stock-scan-lambda/below2002percentNoCross')
    above2002percentCross['Symbol'].to_csv('/home/ec2-user/environment/dart-stock-scan-lambda/above2002percentCross')
    below2002percentCross['Symbol'].to_csv('/home/ec2-user/environment/dart-stock-scan-lambda/below2002percentCross')
