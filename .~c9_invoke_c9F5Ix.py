...
def sendAWSMailAttachment(recipeint,subject,body_text,attachPath):
...
#     print(sys.version)
    ...
    numberofStocksAbove200SMA = len(outputDf[(outputDf['Close'] >= outputDf['200SMA'])].index)
    numberofStocksBelow200SMA = len(outputDf[(outputDf['Close'] < outputDf['200SMA'])].index)
    ...
    # print(BODY_TEXT)
    sendAWSMailAttachment('dartconsultants.hyd@gmail.com',SUBJECT,BODY_TEXT,tmpPath)
